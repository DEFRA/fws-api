...
const schema = Joi.object({
  ...
  feTag: Joi.string(),
  service: Joi.string(),
  s3WarningsBucket: Joi.string(),
  s3WarningsFolder: Joi.string(),
  s3WarningsFile: Joi.string(),
  fwsApiUrl: Joi.string()
})
...
const result = schema.validate({
  ...
  service: process.env.FWS_SERVICE_NAME,
  s3WarningsBucket: process.env.FWS_S3_WARNINGS_BUCKET,
  s3WarningsFolder: process.env.FWS_S3_WARNINGS_FOLDER,
  s3WarningsFile: process.env.FWS_S3_WARNINGS_FILE,
  fwsApiUrl: process.env.FWS_API_URL
})
