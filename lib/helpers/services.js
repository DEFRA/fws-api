...
class Services {
  ...
  errorLog (messageLog) {
    return this.db.query(queries.errorLog, [messageLog.approved, messageLog.targetAreaCode, messageLog.severity, messageLog.situation, messageLog.language, messageLog.dateCreated])
  }
