...
module.exports.handler = async (event, context) => {
  ...
  try {
    ...
    const fwsMessageAsString = JSON.stringify(event.bodyXml).replace(/\\r\\n/g, '\\n')
    console.log(`Processing message: ${fwsMessageAsString}`)
    const fwsMessage = JSON.parse(fwsMessageAsString)
