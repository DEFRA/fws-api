...
class Message {
  ...
  async save (xmlResult) {
    let message = {
      ...
      situationChanged: momemt(xmlResult.WarningMessage.$.approved, 'DD-MM-YYYY HH:mm').format('YYYY-MM-DD HH:mm'),
      severityChanged: momemt(xmlResult.WarningMessage.$.approved, 'DD-MM-YYYY HH:mm').format('YYYY-MM-DD HH:mm'),
